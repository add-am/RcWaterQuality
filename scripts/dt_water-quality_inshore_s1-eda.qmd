...
pacman::p_load(tidyverse, glue, here, sf, tmap, janitor, readxl, ggplot2, busdater)
...
if (exists("inshore_wq_removed")) {# a removed and non-removed set exists, save both
  ...
  write_csv(inshore_wq_all, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_inshore_wq_all_sites_removed.csv"))
  ...
  write_csv(inshore_wq_pre_removal, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_inshore_wq_all_pre_removal.csv"))

} else {#otherwise just save the one
  
  write_csv(inshore_wq_all, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_inshore_wq_all.csv"))
