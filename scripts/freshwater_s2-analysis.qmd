...
fw_wq_annual_wide <- fw_wq_annual |> 
  pivot_wider(names_from = Indicator, values_from = AnnualMedianValues)
...
save_n3_table(
  ...
  glue("{output_path}/fw_appendix_sub_basin_scores"),
  c(2:4),
...
fw_wq_all_scores_grades_raw <- score_to_grade(fw_wq_all_weighted, 18:length(fw_wq_all_weighted))
...
nutri_physchem_prep <- fw_wq_all_scores_grades_floor |> 
