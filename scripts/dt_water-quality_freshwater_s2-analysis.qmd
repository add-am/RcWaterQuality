...
#save data
cond_form_wq_summary_stats(freshwater_summary_stats, glue("{output_path}/summary_statistics"), cols = c(5:6))
...
#save data
cond_form_rc_grades(sub_basin_scores_save, glue("{output_path}/fw_appendix_sub_basin_scores"), cols = c(2:4), method = "numeric")
...
#save data
cond_form_rc_grades(nutrients_table, glue("{output_path}/fw_nutrients"), cols = c(4:10), method = "Numeric")
...
#save data
cond_form_rc_grades(phys_chem_table, glue("{output_path}/fw_phys_chem"), cols = c(4:11), method = "Numeric")
