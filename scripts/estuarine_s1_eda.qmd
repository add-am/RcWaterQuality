...
historical_metadata <- read_excel(
  glue("{data_path}/dt_wq_estuarine_metadata.xlsx"),
...
estuarine_wq_all <- filter(estuarine_wq_all, !Code %in% historical_metadata)
...
if (nrow(location_check) == 12 & !any(is.na(location_check))){
...
stop("Test fail, currently the DT report should have 12 unique watercourses, please cross check if 
...
if (nrow(code_check) == 16 & !any(is.na(code_check))){
...
stop("Test fail, currently the DT report should have 16 unique codes(sites), please cross check if 
