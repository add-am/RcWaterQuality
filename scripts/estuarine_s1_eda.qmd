...
if (exists("estuarine_wq_removed")) {# a removed and non-removed set exists, save both
  ...
  write_csv(estuarine_wq_all, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_estuarine_wq_all_sites_removed.csv"))
  ...
  write_csv(estuarine_wq_pre_removal, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_estuarine_wq_all_pre_removal.csv"))

} else {#otherwise just save the one
  
  write_csv(estuarine_wq_all, 
            glue("{data_path}/{current_fyear-1}-{current_fyear}_estuarine_wq_all.csv"))
